...
public:
	...
	void SetSensorCallbacks(std::unordered_map<std::string, CollisionCallback::SensorCallback>* callbacks) { m_SensorCallbacks = callbacks; }
...
private:
	...
	std::unordered_map<std::string, CollisionCallback::SensorCallback>* m_SensorCallbacks{nullptr};
};